    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    <a href="https://github.com/vantanto/vwallet" class="btn" target="_blank" rel="noreferrer">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h3 class="card-title">No Updates</h3>
                            </div>
...
<div class="navbar-expand-md">
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    <li class="nav-item @if(request()->routeIs('dashboard')) active dropdown @endif">
                    ...
                    <li class="nav-item @if(request()->routeIs('wallets.*')) active dropdown @endif">
