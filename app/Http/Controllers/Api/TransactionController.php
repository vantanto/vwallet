...
class TransactionController extends Controller
{
    ...
    public function create(Request $request, $wallet)
    {
        ...
        return $this->responseSuccess('Wallet Create', [
            'wallet' => $wallet,
            'categories' => $categories,
            'designatedWallets' => $designatedWallets,
        ]);
    }
    ...
    public function store(Request $request, $wallet)
    {
        ...
        try {
            ...
            DB::commit();
            return $this->responseSuccess('Transaction Successfully Created.');
            return response()->json(['status' => 'success', 'msg' => '']);
        } catch (\Exception $ex) {
            DB::rollBack();
            return $this->responseError('Transaction Failed Created.');
        }
    }
    ...
    public function update(Request $request, $wallet, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return $this->responseSuccess('Transaction Successfully Updated.', [
                'wallet' => $wallet,
                'transaction' => $transaction,
            ]);
        } catch (\Exception $ex) {
            DB::rollBack();
            return $this->responseError('Transaction Failed Updated.');
        }
    }
    ...
    public function destroy(Request $request, $wallet, $id)
    {
        ...
        $transaction->delete();
        return $this->responseSuccess('Transaction Successfully Deleted.');
    }
}
